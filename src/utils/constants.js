...
// export const containerPopCreat = popUpCreat.querySelector(
//   ".popup-creat__container"
// );
...
// export const popupRemoveCloseBtn = document.querySelector(
//   ".popup-remove__close"
// );
// export const popupRemoveForm = document.querySelector(".popup-remove__form");
// export const popupRemoveSubmit = document.querySelector(
...
// );
// export const popupAvatarInput = document.querySelector(
//   ".popup-avatar__input-link"
// );
// export const popupAvatarBtnSubmit = document.querySelector(
